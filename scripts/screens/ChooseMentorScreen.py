...
from scripts.utility import get_text_box_theme, scale, mentor_skill_compatibility, get_mentor_compatibility
...
class ChooseMentorScreen(Screens):
    ...
    def screen_switches(self):
        ...
        self.checkbox_show_no_current_app = UIImageButton(scale(pygame.Rect((1260, 650),(68, 68))), "",
                                                       object_id=no_current_app_theme, tool_tip_text='only show mentors with no apprentices')
        ...
        self.checkbox_show_similar_personality = UIImageButton(scale(pygame.Rect((1060, 650),(68, 68))), "",
